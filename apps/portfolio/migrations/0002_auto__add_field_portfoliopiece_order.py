...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortfolioPiece.order'
        db.add_column('portfolio_portfoliopiece', 'order', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortfolioPiece.order'
        db.delete_column('portfolio_portfoliopiece', 'order')
